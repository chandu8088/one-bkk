 ...
 */
 (function (document, $) {
    ...
    function showHide(component, element) {
        ...
        if (target) {
            if (element.checked) {
                $(element).siblings('.togglefield').removeClass("hide");
                $('[data-ticketlabel]').attr("aria-required", "true");
                 //$(element).siblings('.togglefield').attr("aria-required", "true");
             }else{
				$(element).siblings('.togglefield').addClass("hide");
                 $('[data-ticketlabel]').attr("aria-required", "false");
