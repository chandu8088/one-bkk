    ...
    class Jarallax {
        ...
        onScroll(force) {
            ...
            self.isElementInViewport =
                0 <= viewportRect.bottom && 0 <= viewportRect.right && viewportRect.top <= wndH && viewportRect.left <= global$1.innerWidth // stop calculations if item is not in viewport
    ...
    const jarallax = function (items, options, ...args) {
        ...
        if (
            'object' === typeof HTMLElement
                ...
                : items && 'object' === typeof items && null !== items && 1 === items.nodeType && 'string' === typeof items.nodeName
        ) {
            items = [items]
        }
